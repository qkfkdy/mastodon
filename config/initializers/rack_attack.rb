...
class Rack::Attack
  ...
  throttle('throttle_api_media', limit: 300, period: 1.minutes) do |req|
  ...
  throttle('throttle_api_sign_up', limit: 5, period: 3.minutes) do |req|
  ...
  throttle('throttle_api_delete', limit: 300, period: 1.minutes) do |req|
